...
namespace CustomersDLL {
    ...
    public partial class CustomersDataSet : global::System.Data.DataSet {
        ...
        public partial class customersDataTable : global::System.Data.TypedTableBase<customersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public customersRow AddcustomersRow(int CustomerID, int AddressID, string FirstName, string LastName, string AccountNumber, bool ActiveCustomer, string PhoneNumber) {
        ...
        public partial class customersRow : global::System.Data.DataRow {
            ...
            public bool ActiveCustomer {
                get {
                    return ((bool)(this[this.tablecustomers.ActiveCustomerColumn]));
                }
                set {
                    this[this.tablecustomers.ActiveCustomerColumn] = value;
                }
            }
...
namespace CustomersDLL.CustomersDataSetTableAdapters {
    ...
    public partial class customersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([" +
                "AddressID] = @Original_AddressID) AND ([ActiveCustomer] = @Original_ActiveCustom" +
                "er))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ActiveCustomer", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ActiveCustomer", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[customers] ([CustomerID], [AddressID], [FirstName], [LastName], [AccountNumber], [ActiveCustomer], [PhoneNumber]) VALUES (@CustomerID, @AddressID, @FirstName, @LastName, @AccountNumber, @ActiveCustomer, @PhoneNumber);
SELECT CustomerID, AddressID, FirstName, LastName, AccountNumber, ActiveCustomer, PhoneNumber FROM customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ActiveCustomer", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ActiveCustomer", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[customers] SET [CustomerID] = @CustomerID, [AddressID] = @AddressID, [FirstName] = @FirstName, [LastName] = @LastName, [AccountNumber] = @AccountNumber, [ActiveCustomer] = @ActiveCustomer, [PhoneNumber] = @PhoneNumber WHERE (([CustomerID] = @Original_CustomerID) AND ([AddressID] = @Original_AddressID) AND ([ActiveCustomer] = @Original_ActiveCustomer));
SELECT CustomerID, AddressID, FirstName, LastName, AccountNumber, ActiveCustomer, PhoneNumber FROM customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ActiveCustomer", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ActiveCustomer", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_ActiveCustomer", global::System.Data.SqlDbType.Bit, 0, global::System.Data.ParameterDirection.Input, 0, 0, "ActiveCustomer", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, AddressID, FirstName, LastName, AccountNumber, ActiveCustomer," +
                " PhoneNumber FROM dbo.customers";
        ...
        public virtual int Delete(int Original_CustomerID, int Original_AddressID, bool Original_ActiveCustomer) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((bool)(Original_ActiveCustomer));
        ...
        public virtual int Insert(int CustomerID, int AddressID, string FirstName, string LastName, string AccountNumber, bool ActiveCustomer, string PhoneNumber) {
            ...
            this.Adapter.InsertCommand.Parameters[5].Value = ((bool)(ActiveCustomer));
            if ((PhoneNumber == null)) {
        ...
        public virtual int Update(int CustomerID, int AddressID, string FirstName, string LastName, string AccountNumber, bool ActiveCustomer, string PhoneNumber, int Original_CustomerID, int Original_AddressID, bool Original_ActiveCustomer) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((bool)(ActiveCustomer));
            if ((PhoneNumber == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[9].Value = ((bool)(Original_ActiveCustomer));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int AddressID, string FirstName, string LastName, string AccountNumber, bool ActiveCustomer, string PhoneNumber, int Original_CustomerID, int Original_AddressID, bool Original_ActiveCustomer) {
            return this.Update(Original_CustomerID, AddressID, FirstName, LastName, AccountNumber, ActiveCustomer, PhoneNumber, Original_CustomerID, Original_AddressID, Original_ActiveCustomer);
        }
    }
